defmodule SymphonyElixir.Config.Schema do
  ...
  defmodule Tracker do
    ...
    embedded_schema do
      ...
      field(:supabase_view_name, :string, default: "tracker_work_items_v1")
      field(:supabase_items_table, :string, default: "roadmap_items")
  ...
  defp finalize_settings(settings) do
    tracker = %{
      ...
      | api_key: resolve_secret_setting(settings.tracker.api_key, System.get_env("LINEAR_API_KEY")),
        ...
        supabase_url: resolve_secret_setting(settings.tracker.supabase_url, System.get_env("SUPABASE_URL")),
        supabase_secret_key:
